"""
Training a 10 layers neural network with Restaurants dataset
"""
...
# CLASSIFIER
model = nn.Sequential(nn.Linear(x_train.shape[1], 900),
                      nn.ReLU(),
...
optimizer = optim.Adam(model.parameters(), lr=0.0001, weight_decay=0.0001)  # 0.808
...
best_accuracy = 0
best_model = []
PATH = os.path.join(os.getcwd(), f'nn_10_{DATASET}.p')
